...
The following flowchart shows the control flow and this is what was implemented in Sinclair BASIC ([code](https://github.com/eigengrouse/eigenblitz/blob/main/main.zxb)).
