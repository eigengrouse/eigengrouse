...
It probably took as long to create a flowchart and mess around with it as it did to write the Sinclair BASIC and this was just a bit of an exercise in learning how to do this with [mermaidjs](https://mermaid.js.org/). This whole game was a bit of a learning exercise in fact but having an end product i.e the VIC-20 game gave me something to work towards and I was able to figure things out until they were good enough to fit the specification. It also meant I ended up with a game that was quite playable as this concept had been proven, where in the past I have just made things up as I've gone along and the end product was a bit all over the place. There's still plenty of room for creativity and even creating the build pipeline was really satisfying and fun even.