...
flowchart TD
    ...
    q_bomb_ground -- no --> next_column
    q_player_fire -- yes --> player_fire
    q_player_fire -- no --> next_column
    player_fire --> next_column
    remove_bomb --> q_player_fire
    next_column --> next_row
    next_column --> for_column
    next_row --> for_row
    next_row --> gosub_manwaving
